...
def test12():
    ...
    c_cpp_list = find_command_star_node('frameworks/native/services/surfaceflinger/SurfaceFlinger.cpp', '12.0', compdb=True)
    entry_funs = ['SurfaceFlinger::CheckTransactCodeCredentials(']

    c_cpp_list = c_cpp_list[0]
    main_file_analyser = file_analyser()
    pro_path = '/hci/chaoran_data/android-12.0.0_r45/'
...
def test13():
    ...
    with open('jni12.0/jni.json') as file_obj:
        ...
        for cpp_jni in cpp_jni_list:
            ...
            FOUND  android_media_AudioRecord_readInDirectBuffer(JNIEnv *, jobject, jobject, jint, jboolean)  :::  [! (android::recordingAllowed(const android::String16 &, pid_t, uid_t))]
            FOUND  android_media_AudioRecord_setup(JNIEnv *, jobject, jobject, jobject, jintArray, jint, jint, jint, jint, jintArray, jstring, jlong)  :::  [! (android::recordingAllowed(const android::String16 &, pid_t, uid_t))]

            "android.permission.MODIFY_AUDIO_ROUTING"
            FOUND  android_media_AudioRecord_readInDirectBuffer(JNIEnv *, jobject, jobject, jint, jboolean)  :::  [! (android::modifyAudioRoutingAllowed())]
            FOUND  android_media_AudioRecord_setup(JNIEnv *, jobject, jobject, jobject, jintArray, jint, jint, jint, jint, jintArray, jstring, jlong)  :::  [! (android::modifyAudioRoutingAllowed())]
            ...
            *** NEED FIX ***
            "android.permission.MODIFY_AUDIO_ROUTING"
            FOUND  android_media_AudioSystem_removeUidDeviceAffinities(JNIEnv *, jobject, jint)  :::  [! (android::modifyAudioRoutingAllowed())]
            FOUND  android_media_AudioSystem_setUidDeviceAffinities(JNIEnv *, jobject, jint, jintArray, jobjectArray)  :::  [! (android::modifyAudioRoutingAllowed())]
            FOUND  android_media_AudioSystem_registerPolicyMixes(JNIEnv *, jobject, jobject, jboolean)  :::  [needModifyAudioRouting && ! (android::modifyAudioRoutingAllowed())]
            FOUND  android_media_AudioSystem_setAudioPortConfig(JNIEnv *, jobject, jobject)  :::  [! (android::modifyAudioRoutingAllowed())]
            FOUND  android_media_AudioSystem_releaseAudioPatch(JNIEnv *, jobject, jobject)  :::  [! (android::modifyAudioRoutingAllowed())]
            FOUND  android_media_AudioSystem_createAudioPatch(JNIEnv *, jobject, jobjectArray, jobjectArray, jobjectArray)  :::  [! (android::modifyAudioRoutingAllowed())]
            
            UID
            FOUND  android_media_AudioSystem_setLowRamDevice(JNIEnv *, jobject, jboolean, jlong)  :::  [! (android::isAudioServerOrSystemServerUid(uid_t))]
            
            "android.permission.MODIFY_AUDIO_SETTINGS"
            FOUND  android_media_AudioSystem_setMasterBalance(JNIEnv *, jobject, jfloat)  :::  [! (android::settingsAllowed())]
            FOUND  android_media_AudioSystem_setMasterMono(JNIEnv *, jobject, jboolean)  :::  [! (android::settingsAllowed())]
            FOUND  android_media_AudioSystem_setMasterMute(JNIEnv *, jobject, jboolean)  :::  [! (android::settingsAllowed())]
            FOUND  android_media_AudioSystem_setMasterVolume(JNIEnv *, jobject, jfloat)  :::  [! (android::settingsAllowed())]
            FOUND  android_media_AudioSystem_setVolumeIndexForAttributes(JNIEnv *, jobject, jobject, jint, jint)  :::  [! (android::settingsAllowed())]
            FOUND  android_media_AudioSystem_setStreamVolumeIndex(JNIEnv *, jobject, jint, jint, jint)  :::  [! (android::settingsAllowed())]
            FOUND  android_media_AudioSystem_initStreamVolume(JNIEnv *, jobject, jint, jint, jint)  :::  [! (android::settingsAllowed())]
            FOUND  android_media_AudioSystem_setPhoneState(JNIEnv *, jobject, jint)  :::  [! (android::settingsAllowed())]
            FOUND  android_media_AudioSystem_setPhoneState(JNIEnv *, jobject, jint)  :::  [! (android::settingsAllowed())]
            FOUND  android_media_AudioSystem_handleDeviceConfigChange(JNIEnv *, jobject, jint, jstring, jstring, jint)  :::  [! (android::settingsAllowed())]
            FOUND  android_media_AudioSystem_setDeviceConnectionState(JNIEnv *, jobject, jint, jint, jstring, jstring, jint)  :::  [! (android::settingsAllowed())]
            FOUND  android_media_AudioSystem_muteMicrophone(JNIEnv *, jobject, jboolean)  :::  [! (android::settingsAllowed())]
            ...
            main_file_analyser = file_analyser()
            main_file_analyser.run(file, pro_path, ninja_args, entry_funs=entry_funs, extend_analyze=True,
                                   anti_search=False, print_all_node=False, generate_html=True)
