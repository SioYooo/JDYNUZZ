...
def extract_save():
    ...
    if not os.path.exists('/home/siyu/tifs/JDYNUZZ/JNI_Analyzer/jni12.0'):
        os.makedirs('/home/siyu/tifs/JDYNUZZ/JNI_Analyzer/jni12.0')
        
    with open('/home/siyu/tifs/JDYNUZZ/JNI_Analyzer/jni12.0/jni.json', 'w') as file_obj:
        json.dump(cpp_jni_list, file_obj)
        print('save in', save_path, '|', len(cpp_jni_list))

    # with open(save_path2, 'w') as file_obj:
    with open('/home/siyu/tifs/JDYNUZZ/JNI_Analyzer/jni12.0/jni_class_list.json', 'w') as file_obj:
    ...
    with open('/home/siyu/tifs/JDYNUZZ/JNI_Analyzer/jni12.0/list.txt', 'w') as file_obj:
        str = ''
        ...
        file_obj.write(str)
        print('save in jni12.0/list.txt', '|', len(cpp_jni_class_list))
